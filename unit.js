...
const D1 = { width: 30, height: 20, color: 'red', type: 'normal', moving: directDown, missile: [basicEnemyMissile], hp: 20, attackInterval: 50, speed: 2 };
const D2 = { width: 30, height: 20, color: 'red', type: 'normal', moving: downAndUp, missile: [basicEnemyMissile], hp: 20, attackInterval: 50, speed: 2 };
